function [V] = rw_online_w_replacing_traces(lambda,alpha,n_rw_states,nEpisodes)
% RW_ONLINE_W_REPLACING_TRACES - Performs td(lambda) learning with {\em replacing} 
% eligibility traces
% 
% Written by:
% -- 
...
for ei=1:nEpisodes,
  ...
  for t=0:(T-1),    % <- STATE index ... 
    ...
    % implement REPLACING elagability traces:
    et(st) = 1;  
