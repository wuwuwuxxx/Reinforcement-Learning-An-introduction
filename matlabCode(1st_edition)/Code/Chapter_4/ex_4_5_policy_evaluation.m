function [V] = ex_4_5_policy_evaluation(V,pol_pi,emp_pol_pi,gamma,Ra,Pa,Rb,Pb,max_num_cars_can_transfer,max_cars_can_store)
...
while( (delta > CONV_TOL) && (iterCnt <= MAX_N_ITERS) ) 
  ...
  for si=1:nStates, 
    ...
    ntrans = pol_pi(na1,nb1); useEmp = emp_pol_pi(na1,nb1); 
    ...
    %---
    tic;
    V(na1,nb1) = ex_4_5_rhs_state_value_bellman(na,nb,ntrans,useEmp,V,gamma,Ra,Pa,Rb,Pb,max_num_cars_can_transfer,max_cars_can_store);
    tm=toc;
